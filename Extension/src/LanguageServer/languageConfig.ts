...
function constructCommentRules(comment: CommentPattern, languageId: string): Rules {
    if (comment?.begin?.startsWith('/*') && (languageId === 'c' || languageId === 'cpp' || languageId === 'cuda-cpp' || languageId === 'mate')) { // for mate p
    ...
    } else if (comment?.begin?.startsWith('//') && (languageId === 'cpp' || languageId === 'cuda-cpp' || languageId === 'mate')) { // for mate p
